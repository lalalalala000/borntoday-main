...
# Функция для преобразования даты вида "11 ноября 1974" в объект date
...
# Исходные данные
stars_data = [
    {"id": 1, "name": "Дмитрий Мешков", "country": "Россия", "category": "Спорт", "birth_date": "30 августа 2006",
     "content": "Просто чилловый парень.", "is_published": True},

    {"id": 2, "name": "Александр Михайлов", "country": "Россия, Киев", "category": "Спорт",
     "birth_date": "4 января 2006",
     "content": "Сладкая булочка с корицей", "is_published": True},

    {"id": 3, "name": "Никита Смирнов", "country": "Россия", "category": "КиберСпорт", "birth_date": "9 января 2006",
     "content": "Баночный король всего лоутаба", "is_published": True},

    {"id": 12, "name": "Адель", "country": "Великобритания", "category": "Музыка", "birth_date": "5 мая 1988",
     "content": "Британская певица и автор песен, лауреат Грэмми.", "is_published": True},

    {"id": 13, "name": "Криштиану Роналду", "country": "Португалия", "category": "Спорт",
     "birth_date": "5 февраля 1985",
    ...
    {"id": 11, "name": "Леонардо ДиКаприо", "country": "США", "category": "Кино", "birth_date": "11 ноября 1974",
...
def load_stars():
   # Создаем словари для хранения объектов стран и категорий
   countries = {}
   categories = {}

   print("Начало загрузки данных...")

   # Создаем страны, если они не существуют
   ...
   for star_data in stars_data:
       ...
       if not Star.objects.filter(name=star_data["name"]).exists():
           try:
               # Используем нашу функцию для преобразования русской даты
               birth_date = parse_russian_date(star_data["birth_date"])

               # Создаем знаменитость
               star = Star(
                   name=star_data["name"],
               ...
               star.save()  # Сохраняем, чтобы создать slug

               # Добавляем категорию
               star.categories.add(categories[star_data["category"]])
